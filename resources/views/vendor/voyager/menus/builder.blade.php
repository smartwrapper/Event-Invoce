            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        {{-- CUSTOM --}}
                        <label for="icon_class">{{ __('voyager::menu_builder.icon_class') }} <br>
                        ...
                        {{-- <input type="color" class="form-control" id="m_color" name="color" placeholder="{{ __('voyager::menu_builder.color_ph') }}"><br> --}}
